  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Reviews</Text>
        <View style={{ width: 40 }} />
      </View>
      <View style={styles.content}>
        <MessageSquare color={colors.textSecondary} size={48} />
        <Text style={[styles.title, { color: colors.textPrimary }]}>No reviews yet</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          When travelers review your trips, they will appear here.
        </Text>
      </View>
    </SafeAreaView>
  );
