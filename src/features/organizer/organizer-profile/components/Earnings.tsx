  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        <CircleDollarSign color={colors.textSecondary} size={48} />
        <Text style={[styles.title, { color: colors.textPrimary }]}>No earnings yet</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Complete trips and get paid. Your earnings will appear here.
        </Text>
      </View>
    </SafeAreaView>
  );
