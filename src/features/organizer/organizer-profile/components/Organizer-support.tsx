...
import { ChevronLeft, HeadphonesIcon } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Organizer Support</Text>
        <View style={{ width: 40 }} />
      </View>
      <View style={styles.content}>
        <HeadphonesIcon color={colors.textSecondary} size={48} />
        <Text style={[styles.title, { color: colors.textPrimary }]}>We're here to help</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Need assistance with your trips or payments? Contact our dedicated organizer support team.
        </Text>
      </View>
    </SafeAreaView>
  );
